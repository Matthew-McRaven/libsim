...
std::array<addressing_mode, 256> addr_array =
{
	...
	ad::NONE ,  ad::INVALID, ad::INVALID, ad::INVALID, ad::INVALID, ad::INVALID, ad::INVALID, ad::INVALID,   // 0b0000'1000
	ad::NONE,   ad::NONE,    ad::NONE,    ad::NONE,    ad::NONE,    ad::NONE,    ad::NONE,    ad::NONE,      // 0b0001'0000
	ad::NONE,   ad::NONE,    ad::NONE,    ad::NONE,    ad::I,       ad::X,       ad::I,       ad::X,         // 0b0001'1000

	ad::I,      ad::X,       ad::I,       ad::X,       ad::I,       ad::X,       ad::I,       ad::X,         // 0b0010'0000
	ad::I,      ad::X,       ad::I,       ad::X,       ad::I,       ad::X,       ad::I,       ad::X,         // 0b0010'1000
	ad::I,      ad::D,       ad::N,       ad::S,       ad::SF,      ad::X,       ad::SX,      ad::SFX,       // 0b0011'0000
    ad::I,      ad::INVALID, ad::INVALID, ad::INVALID, ad::INVALID, ad::INVALID, ad::INVALID, ad::INVALID,   // 0b0011'1000
    ...
    ad::INVALID,ad::D,       ad::N,       ad::S,       ad::SF,      ad::X,       ad::SX,      ad::SFX,       // 0b0110'0000
    ad::INVALID,ad::D,       ad::N,       ad::S,       ad::SF,      ad::X,       ad::SX,      ad::SFX,       // 0b0110'1000
    ad::INVALID,ad::D,       ad::N,       ad::S,       ad::SF,      ad::X,       ad::SX,      ad::SFX,       // 0b0111'0000
    ad::INVALID,ad::D,       ad::N,       ad::S,       ad::SF,      ad::X,       ad::SX,      ad::SFX,       // 0b0111'1000
	...
	ad::I,      ad::D,       ad::N,       ad::S,       ad::SF,      ad::X,       ad::SX,      ad::SFX,       // 0b1110'0000
    ad::I,      ad::D,       ad::N,       ad::S,       ad::SF,      ad::X,       ad::SX,      ad::SFX,       // 0b1110'1000

	ad::I,      ad::D,       ad::N,       ad::S,       ad::SF,      ad::X,       ad::SX,      ad::SFX,       // 0b1111'0000
    ad::I,      ad::D,       ad::N,       ad::S,       ad::SF,      ad::X,       ad::SX,      ad::SFX,       // 0b1111'1000
};
