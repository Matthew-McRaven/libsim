...
echo "using python : 3.9 : ../../build/python3/usr/local/bin/python3 : ../../build/python3/usr/local/include/python3.9 : ../../build/python3/usr/local/lib/python3.9 : ;" > boost/user-config.jam
