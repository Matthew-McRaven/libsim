...
void isa_processor::unary_dispatch(uint8_t is)
{
	...
	case instruction_mnemonic::RETTR:
	...
	case instruction_mnemonic::RORX:
		...
		set_NZVC(CSR::C, idx & 0x1);
        break;
	case instruction_mnemonic::DECI:
	case instruction_mnemonic::DECO:
	case instruction_mnemonic::HEXO:
	case instruction_mnemonic::STRO:
	case instruction_mnemonic::NOP0:
	case instruction_mnemonic::NOP1:
