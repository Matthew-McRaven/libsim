...
block_computer<regbank_t, mem_device_t>::block_computer(regbank_t regbank, mem_device_t memory): 
	regbank(regbank), memory(memory), proc({})
{
	...
	auto read_mem_lambda = [this](uint16_t addr, bool d) {return this->memory.read_byte(addr, d);};
	_iface.read_mem_byte = std::function<uint8_t(uint16_t, bool)>(read_mem_lambda);
	auto write_mem_lambda = [this](uint16_t addr, uint8_t val, bool d){this->memory.write_byte(addr, val, d);};
	...
	auto write_reg_lambda = [this](uint8_t addr, uint16_t val){this->regbank.write_reg(addr, val);};
	...
	auto write_csr_lambda = [this](uint8_t addr, bool val){this->regbank.write_csr(addr, val);};
...
template <typename regbank_t, typename mem_device_t>
block_computer<regbank_t, mem_device_t>::sim_interface_t block_computer<regbank_t, mem_device_t>::sim_interface() {
	block_computer<regbank_t, mem_device_t>::sim_interface_t ret;
...
template <typename regbank_t, typename mem_device_t>
block_computer<regbank_t, mem_device_t>::delta_t block_computer<regbank_t, mem_device_t>::get_delta() const
{
...
template <typename regbank_t, typename mem_device_t>
block_computer<regbank_t, mem_device_t>::delta_t block_computer<regbank_t, mem_device_t>::step()
{
	proc.step();
...
template <typename regbank_t, typename mem_device_t>
block_computer<regbank_t, mem_device_t>::delta_t block_computer<regbank_t, mem_device_t>::apply(block_computer::delta_t)
{
	throw std::invalid_argument("Not implemented");
}

template <typename regbank_t, typename mem_device_t>
uint8_t block_computer<regbank_t, mem_device_t>::read_mem_byte(uint16_t addr, bool d) const
{
	return memory.read_byte(addr, d);
}

template <typename regbank_t, typename mem_device_t>
void block_computer<regbank_t, mem_device_t>::write_mem_byte(uint16_t addr, uint8_t value, bool d)
{
	memory.write_byte(addr, value, d);
}

template <typename regbank_t, typename mem_device_t>
void block_computer<regbank_t, mem_device_t>::clear_memory()
{
	return memory.clear();
}

template <typename regbank_t, typename mem_device_t>
uint16_t block_computer<regbank_t, mem_device_t>::read_reg(uint8_t addr) const
{
	return regbank.read_reg(addr);
}

template <typename regbank_t, typename mem_device_t>
void block_computer<regbank_t, mem_device_t>::write_reg(uint8_t addr, uint16_t value)
{
...
template <typename regbank_t, typename mem_device_t>
void block_computer<regbank_t, mem_device_t>::clear_regs()
{
	regbank.clear_regs();
}

template <typename regbank_t, typename mem_device_t>
uint16_t block_computer<regbank_t, mem_device_t>::read_csr(uint8_t addr) const
{
	return regbank.read_csr(addr);
}

template <typename regbank_t, typename mem_device_t>
void block_computer<regbank_t, mem_device_t>::write_csr(uint8_t addr, bool value)
{
...
template <typename regbank_t, typename mem_device_t>
void block_computer<regbank_t, mem_device_t>::clear_csrs()
{
	regbank.clear_csrs();
}
