...
{
	return std::move(components::machine::TransactionLocker<address_size_t, memory_val_size_t, memory_vector_t>(*this));
}
...
{
	return std::move(components::machine::InstructionLocker<address_size_t, memory_val_size_t, memory_vector_t>(*this));
}