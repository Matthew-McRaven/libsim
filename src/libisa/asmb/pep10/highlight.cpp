...
std::map<asmb::highlight_type, std::string> asmb::pep10::construct_rules()
{
	...
	std::transform(isa.isa.begin(), isa.isa.end(),
		std::back_inserter(help),
	...
	rules[asmb::highlight_type::kCharQuote] = "((\')(?![\'])(([^\'|\\\\]){1}|((\\\\)([\'|b|f|n|r|t|v|\"|\\\\]))|((\\\\)(([x|X])([0-9|A-F|a-f]{2}))))(\'))";
	rules[asmb::highlight_type::kStrQuote] = "((\")((([^\"|\\\\])|((\\\\)([\'|b|f|n|r|t|v|\"|\\\\]))|((\\\\)(([x|X])([0-9|A-F|a-f]{2}))))*)(\"))";
